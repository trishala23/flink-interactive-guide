...
A free, static, interactive web guide for learning Apache Flink. Seven
modules, each pairing a short theory explanation with a hands-on browser
widget and a quiz. Zero backend, zero build step, zero dependencies —
deployed as-is to GitHub Pages. Read `README.md` for the full feature list
and roadmap.
...
modules/NN-slug.html           One file per module (01 through 07)
